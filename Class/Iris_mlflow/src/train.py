...
#"""Train Random Forest model with MLflow tracking"""
    ...
    # Log parameters
        ...
        return model, test_metrics['accuracy'],best_run_id
...
# Load and preprocess data
    ...
    for params in rf_params:
        with mlflow.start_run(nested=True,run_name=f"RF_estimators_{params['n_estimators']}_depth_{params['max_depth']}"):
            model, accuracy,best_run_id = train_random_forest(X_train, y_train, X_test,y_test, **params)
    ...
    for params in lr_params:
        with mlflow.start_run(nested=True, run_name=f"LR_C_{params['C']}"):
            model, accuracy,best_run_id = train_logistic_regression(X_train, y_train,
...
#"""Demonstrate model registry functional
